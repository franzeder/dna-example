...
```{r congruence network 2002, out.width="150%", cache=TRUE, message=FALSE, echo=c(6:200)}
dna_init()
conn <- dna_connection("dna_example_UKIraqWar2003.dna", verbose = FALSE)
organization <- dna_getAttributes(conn, variable = "organization")
person <- dna_getAttributes(conn, variable = "person")
...
```{r congruence network 2003, out.width="150%", cache=TRUE, message=FALSE, echo=c(6:200)}
dna_init()
conn <- dna_connection("dna_example_UKIraqWar2003.dna", verbose = FALSE)
organization <- dna_getAttributes(conn, variable = "organization")
person <- dna_getAttributes(conn, variable = "person")
...
```{r cluster analysis 2002, out.width="150%", cache=TRUE, message=FALSE, echo=c(6:200)}
dna_init()
conn <- dna_connection("dna_example_UKIraqWar2003.dna", verbose = FALSE)
organization <- dna_getAttributes(conn, variable = "organization")
person <- dna_getAttributes(conn, variable = "person")
...
```{r cluster analysis 2003, out.width="150%", cache=TRUE, message=FALSE, echo=c(6:200)}
dna_init()
conn <- dna_connection("dna_example_UKIraqWar2003.dna", verbose = FALSE)
organization <- dna_getAttributes(conn, variable = "organization")
person <- dna_getAttributes(conn, variable = "person")
